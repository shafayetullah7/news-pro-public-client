        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:w-[800px] mx-auto justify-items-center">
            <div className="w-[140px] h-[140px] border-2 text-gray-700 dark:text-gray-300 border-gray-700 dark:border-gray-300 flex items-center justify-center flex-col gap-5 rounded-lg">
                ...
                <div className="">
                    ...
                    <p className="text-xs  text-center">789 Oak Avenue, Miami, Florida, United States</p>
                </div>
            </div>
            <div className="w-[140px] h-[140px] border-2 text-gray-700 dark:text-gray-300 border-gray-700 dark:border-gray-300 flex items-center justify-center flex-col gap-5 rounded-lg ">
                ...
                <div className="mt-2">
                    <h1 className="text-center font-bold">Our Main Office</h1>
                    <p className="text-xs  text-center">+1 (555) 123-4567,</p>
                    <p className="text-xs  text-center">+1 (555) 987-6543</p>
                </div>
            </div>
            <div className="w-[140px] h-[140px] border-2 text-gray-700 dark:text-gray-300 border-gray-700 dark:border-gray-300 flex items-center justify-center flex-col gap-5 rounded-lg ">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-xs  text-center">+1 (555) 789-0123</p>
                </div>
            </div>
            <div className="w-[140px] h-[140px] border-2 text-gray-700 dark:text-gray-300 border-gray-700 dark:border-gray-300 flex items-center justify-center flex-col gap-5 rounded-lg ">
                ...
                <div className="">
                    ...
                    <p className="text-xs  text-center w-full  ">newspro@example.com</p>
                </div>
            </div>
        </div>
    );
